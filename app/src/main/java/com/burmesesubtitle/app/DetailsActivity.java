...
import com.burmesesubtitle.app.adapters.CastCrewAdapter;
import com.burmesesubtitle.app.adapters.CommentsAdapter;
import com.burmesesubtitle.app.adapters.DownloadAdapter;
import com.burmesesubtitle.app.adapters.EpisodeAdapter;
import com.burmesesubtitle.app.adapters.HomePageAdapter;
import com.burmesesubtitle.app.adapters.LiveTvHomeAdapter;
import com.burmesesubtitle.app.adapters.ProgramAdapter;
import com.burmesesubtitle.app.adapters.ServerApater;
import com.burmesesubtitle.app.models.CastCrew;
...
import com.burmesesubtitle.app.models.Program;
import com.burmesesubtitle.app.models.SubtitleModel;
    ...
    private void initGetData() {
        ...
        if (!type.equals("tv")) {
            ...
            if (type.equals("tvseries")) {
                ...
                rvDownload.setAdapter(episodeAdapter);
...
//                epDownload.setAdapter(episodeDownloadAdpter);
    ...
    public void initVideoPlayer(String url, Context context, final String type) {
